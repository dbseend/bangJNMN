      ...
      <Div>
        <UserData>
          ...
          <div>
            <InfoBox>
              <p>
                <b>이름</b> <Info>{user.name}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>학번</b> <Info>{user.stuNum}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>팀</b> <Info>{user.team}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>전공</b> <Info>{user.major}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>생년월일</b> <Info>{user.birth}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>인실</b> <Info>{Room(user.roommateNum)}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>이메일</b> <Info>{user.email}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>성별</b> <Info>{user.gender}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>전화번호</b> <Info>{user.phoneNumber}</Info>
              </p>
            </InfoBox>
            <InfoBox>
              <p>
                <b>기숙사</b> <Info>{user.dorm}</Info>
              </p>
            </InfoBox>
